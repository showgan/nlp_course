...
# Instead of loading the Spacy model here, load it in the application and provide it as an argument
# where it's needed.
# import spacy
...
def _get_stopwords_counts(x):
	return len([t for t in x.split() if t in STOP_WORDS])
